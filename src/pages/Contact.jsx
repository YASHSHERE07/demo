...
const Contact = () => {
  const mapSrc =
    "https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2884.0347451596895!2d-79.653237!3d43.709827!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x882b3df6c2436c35:0xdf30b29fb9f562ba!2sTouch+Abroad+Educational+Services,+2985+Drew+Rd+%23220,+Mississauga,+ON+L4T+0A4,+Canada!5e0!3m2!1sen!2sin!4v1698723853843!5m2!1sen!2sin";
            ...
            <div class="col-span-4 bg-gray-50 px-8 py-10 text-gray-800 md:col-span-2 md:border-r md:px-10 md:py-12 lg:col-span-1">
              ...
              <ul>
                ...
                <li class="my-6 flex items-center text-left">
                  ...
                  <div>
                    <p class="font-serif text-base md:text-lg">id</p>
...
<h1 className="text-5xl text-center font-bold">
      ...
      <div className="flex justify-center p-4">
        <a
          href="https://www.google.com/maps/place/Touch+Abroad+Educational+Services/@43.710976,-79.6555442,17z/data=!4m6!3m5!1s0x882b3df6c2436c35:0xdf30b29fb9f562ba!8m2!3d43.7109876!4d-79.6529621!16s%2Fg%2F11rmrgrgz_?entry=ttu"
          target="_blank"
          rel="noopener noreferrer"
        >
          <img src={mapImg} className="border-4 rounded-xl" alt="" />
        </a>
      </div>
    </div>
  );
